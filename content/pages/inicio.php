            ...
            <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/Promoções/faro.png"  class="d-block w-10" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="img/Promoções/turtle.jpg"  class="d-block w-10" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="img/Promoções/acana.jpg" class="d-block w-100" alt="...">
                    </div>
                </div>
